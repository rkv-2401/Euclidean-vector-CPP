TEST_CASE("Equal and not equal") {
	...
	auto init_vector_copy = comp6771::euclidean_vector(init_list);
	auto diff_init_vector = comp6771::euclidean_vector(diff_init_list);
...
TEST_CASE("Arithmetic operations"){
	auto a1 = comp6771::euclidean_vector(5, 1.0);
	auto a1_vec = a1.get_mag();
	auto a2 = comp6771::euclidean_vector(5, 2.0);
	auto a2_vec = a2.get_mag();
	auto a3 = comp6771::euclidean_vector(5, 3.0);
	auto a3= a3.get_mag();
	auto a4= comp6771::euclidean_vector(5, 5.0);
	auto a4= a4.get_mag();
	auto a5= comp6771::euclidean_vector(5, 6.0);
	auto a5= a5.get_mag();
	auto a6= comp6771::euclidean_vector(5, 10.0);
	auto a6= a6.get_mag();
	//operations:
	auto addition = a1 + a1;
