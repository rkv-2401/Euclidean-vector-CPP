...
TEST_CASE("Constructor with single argument"){
	auto const single_arg_ctr = comp6771::euclidean_vector(4);
...
TEST_CASE("Constructor with two arguments"){
	auto const double_arg_ctr = comp6771::euclidean_vector(4, 2.0);
...
TEST_CASE("Constructor with iterator"){
	...
	auto const iter_arg_ctr = comp6771::euclidean_vector(iter_vec.begin(), iter_vec.end());
...
TEST_CASE("Constructor with Initializer List"){
	...
	auto const init_list_ctr = comp6771::euclidean_vector(init_list);
...
TEST_CASE("Copy constructor test"){
	auto const double_arg_ctr = comp6771::euclidean_vector(4, 2.0);
	auto copy_ctr = comp6771::euclidean_vector(double_arg_ctr);
...
TEST_CASE("Move constructor test"){
	auto const double_arg_ctr = comp6771::euclidean_vector(4, 2.0);
	auto temp_move_ctr = comp6771::euclidean_vector(double_arg_ctr);
	auto move_ctr = comp6771::euclidean_vector(std::move(temp_move_ctr));
	auto double_arg_vector_cpy = std::vector<double>();
	for (auto iter = 0; iter < 4; iter++){
		double_arg_vector_cpy.push_back(2.0);
	}
